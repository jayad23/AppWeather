        ...
        <img className="max-w-1/2 max-h-1/2 inline " src={data.weather[0].description === "few clouds" ? partlyCloudy : 
            ...
            <section className="flex-col  rounded top-20  my-0 py-4 px-4  -mt-20 bg-whiteAplha ">
                ...
                <div className="flex justify-between my-4">
                        <button onClick={()=>handlerHistory(1)} className="border-2 border-red-500 text-red rounded-md px-2 py-1 font-bold">Go Back</button>
                        <button onClick={()=>handlerHistory(2)} className="border-2 border-red-500 text-red rounded-md px-2 py-1 font-bold">Home</button>
                        <button onClick={()=>handlerHistory(3)} className="border-2 border-red-500 text-red rounded-md px-2 py-1 font-bold">Next</button>
                </div>  
            </section>
        </article>
        :null 
